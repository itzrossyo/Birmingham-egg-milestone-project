...
Birmingham egg is a responsive website designed to provide information about Birmingham Egg, a local business specializing in high-quality eggs and
poultry products. The website aims to showcase their range of products, provide details on how to visit their location, and offer convenient contact
options for inquiries and deliveries.
...
The website is optimized to be accessible on various devices, ensuring that users can easily explore Birmingham Egg's offerings regardless of whether
they are using a desktop computer, tablet, or mobile phone.

### Initial Discussion

Birmingham egg is a real life website for that's been redesign for modern internet showing all the information about the team members and products
that they have for sale.

#### Key information for the site

- how to get there.
- contact information about delivery's or for more information.
...
- As a client, I want to be able to view the website on a range of device sizes to ensure accessibility for all users.
    ...
    - [Samsung s20 ultra](https://raw.githubusercontent.com/itzrossyo/Birmingham-egg-milestone-project/main/assets/images/webiste-visitor-goals/samsung-galaxy-s20-ultra.webp)
...
The website uses a palette of pastel colours that are often used in the Birmingham Eggs images. The colour palette was created using
the [Colors](https://coolors.co/) website.

- The main color for the footer and nav bar throughout the website. - #D57b65 ![#D57b65](https://placehold.co/15x15/D57b65/D57b65.png)

- The main color that was used throughout the website background. - #fdf2ee ![#fdf2ee](https://placehold.co/15x15/fdf2ee/fdf2ee.png)
- For the contact form I went with the color. - #6aa2aa ![#6aa2aa](https://placehold.co/15x15/6aa2aa/6aa2aa.png)
- To make the dropdown menu stand out when on mobile I went for something a little darker -
  #7a7373 ![#7a7373](https://placehold.co/15x15/7a7373/7a7373.png)

### Typography

Google Fonts was used for the following fonts:

- Roboto is used throughout the site. with a full back ans-serif.
...
[Home Page Wireframe](https://github.com/itzrossyo/Birmingham-egg-milestone-project/blob/cbaa7a510ccdd3fb71eadb32345eed50b43b2b8f/assets/readme-images/homepage-desktop.png)

[Products page Wireframe](https://github.com/itzrossyo/Birmingham-egg-milestone-project/blob/cbaa7a510ccdd3fb71eadb32345eed50b43b2b8f/assets/readme-images/products-desktop.png)

[About Us Wireframe](https://github.com/itzrossyo/Birmingham-egg-milestone-project/blob/cbaa7a510ccdd3fb71eadb32345eed50b43b2b8f/assets/readme-images/about-us-desktop.png)

---

### Features

The website comprises 9 pages, all are accessible from the navigation menu (home page, products page, about us page & contact us page). The 5 other
page is an is shown once a user is on the product page, and then they are able to select other products to filter out.

- All Pages on the website have:

    - A responsive navigation bar at the top which allows the user to navigate through the site. To the left of the navigation bar is a slogan of
      birmingham eggs moto. in the center of the navigation bar are the links to the websites pages (home, products, about us and contact). To allow a
      good user experience of the site, the links are hidden with a media query on mobile devices to prevent the navigation bar looking cluttered.
      When viewing with mobile devices the navigation links change to a burger toggle. This was implemented to give the site a clean look and to
      promote a good user experience, as users are used to seeing the burger icon when on mobile devices to navigate a site.

    - A footer which contains the copyright information for the company

- Home Page.

    - what are Birmingham egg main features and what they sale
    - with a dropdown menu for accessing the map in mobile or at the bottom of the screen. on desktop there is a map the map will open up Google Maps
...
- Contact Us Page.
    ...
    - Form.
        ...
        - The form contains the users name, email address a text area for the user to add further information. The user submits the form using the
          submit button. what will open new page open saying thank you Users must fill in the name, email and text area fields to be able to submit
          the form. If they don't a tooltip will guide them to fill in any information they have missed. once this has been submitted the form will be
          sent to the bussnes email

- Products.

    - a whole section of products that birmingham egg have for sale

- ease of access the contact by phone button will open a pop-up asking you if you would like to use facetime or any other type of call software you
  use on a laptop/pc.
...
- Webstorm - different choice of IDE.
...
- [formspree.io](https://formspree.io) - for easy form submitting.
...
4. Click on the Pages link on the left hand side navigation bar.
...
To download the Birmingham Egg repository:

1. Log in (or sign up) to GitHub.
2. Go to the repository for this project, [Birmingham-egg-milestone-project](https://github.com/itzrossyo/Birmingham-egg-milestone-project)
3. Click on the code button, abd select download Zip.
4. Easy way [Click here](https://github.com/itzrossyo/Birmingham-egg-milestone-project/archive/refs/heads/main.zip).

---

#### Full Testing

- Testing was ongoing throughout the entire build. I utilised Chrome developer tools while building to pinpoint and troubleshoot any issues as I went
  along.
...
- Big was found for search products as th search bar will only work on the all product page - [Known Bugs](#Known-Bugs).
...
- [style.css](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2Fitzrossyo.github.io%2FBirmingham-egg-milestone-project%2F&profile=css3svg&usermedium=all&warning=1&vextwarning=&lang=en#warnings)
...
- As this was a real life project for a company and I will be building off this with new features.

- There is now no audio or video was placed onto website or pages.

- I am importing css into one css stylesheet.

- The popup window will only show up if the user clicks onto the contact button for call us or email.

- On the home page, there is no hamburger menu button due to the client wanting to make sure people know where to click for more information.

### Credits

All code in the project was done by my sell with only reading the documentation
